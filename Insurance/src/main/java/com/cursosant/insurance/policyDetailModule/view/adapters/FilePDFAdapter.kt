 ...
 * Created by Alain Nicolás Tello on 04/06/23 at 16:05
 ...
 ***/
class FilePDFAdapter @Inject constructor(diff: FilePDFDiff) :
    ListAdapter<FilePDF, RecyclerView.ViewHolder>(diff){
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view){
        ...
        fun setListener(file: FilePDF){
            binding?.root?.setOnClickListener { listener.onClick(file) }
        }
    }
}